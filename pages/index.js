      ...
      <body>
        ...
        <div class="page page-break">
          ...
          <div class="section">
            ...
            <!-- LEGENDA DOS CRITÉRIOS DO COMPARATIVO -->
            <div class="legend-box" style="margin-top: 25px; background: #f8fafc; border-radius: 12px; padding: 20px; border: 1px solid #e2e8f0;">
              <div style="font-size: 11pt; font-weight: 600; color: #1e293b; margin-bottom: 15px; display: flex; align-items: center; gap: 8px;">
                📖 Glossário dos Critérios
              </div>
              <div style="display: grid; grid-template-columns: repeat(2, 1fr); gap: 12px; font-size: 9pt;">
                <div style="background: white; padding: 12px; border-radius: 8px; border-left: 3px solid #3b82f6;">
                  <strong style="color: #1e40af;">🎯 Score Total</strong>
                  <p style="color: #64748b; margin-top: 4px; line-height: 1.5;">Pontuação geral de compatibilidade do país com seu perfil. Calculado pela média ponderada das 5 dimensões de análise.</p>
                </div>
                <div style="background: white; padding: 12px; border-radius: 8px; border-left: 3px solid #22c55e;">
                  <strong style="color: #166534;">💰 Custo de Vida</strong>
                  <p style="color: #64748b; margin-top: 4px; line-height: 1.5;">Nível de gastos mensais médios. "Baixo" = mais acessível, "Alto" = mais caro. Afeta diretamente sua qualidade de vida inicial.</p>
                </div>
                <div style="background: white; padding: 12px; border-radius: 8px; border-left: 3px solid #f59e0b;">
                  <strong style="color: #a16207;">🛡️ Segurança</strong>
                  <p style="color: #64748b; margin-top: 4px; line-height: 1.5;">Índice geral de segurança pública. Considera criminalidade, estabilidade política e infraestrutura de saúde.</p>
                </div>
                <div style="background: white; padding: 12px; border-radius: 8px; border-left: 3px solid #8b5cf6;">
                  <strong style="color: #6d28d9;">🇧🇷 Comunidade BR</strong>
                  <p style="color: #64748b; margin-top: 4px; line-height: 1.5;">Presença de brasileiros no país. Comunidade maior facilita adaptação, networking e suporte inicial.</p>
                </div>
                <div style="background: white; padding: 12px; border-radius: 8px; border-left: 3px solid #ec4899;">
                  <strong style="color: #be185d;">🌡️ Clima</strong>
                  <p style="color: #64748b; margin-top: 4px; line-height: 1.5;">Tipo climático predominante. Considere sua adaptabilidade a temperaturas e estações do ano.</p>
                </div>
                <div style="background: white; padding: 12px; border-radius: 8px; border-left: 3px solid #06b6d4;">
                  <strong style="color: #0e7490;">⏱️ Cidadania</strong>
                  <p style="color: #64748b; margin-top: 4px; line-height: 1.5;">Tempo mínimo de residência legal para solicitar naturalização. Alguns países não oferecem cidadania (ex: Emirados).</p>
                </div>
                <div style="background: white; padding: 12px; border-radius: 8px; border-left: 3px solid #64748b;">
                  <strong style="color: #374151;">🗣️ Idioma</strong>
                  <p style="color: #64748b; margin-top: 4px; line-height: 1.5;">Língua oficial do país. Dominar o idioma acelera integração profissional e social.</p>
                </div>
              </div>
            </div>

            <!-- LEGENDA DAS DIMENSÕES DE ANÁLISE (RADAR) -->
            <div class="legend-box" style="margin-top: 20px; background: linear-gradient(135deg, #eff6ff, #dbeafe); border-radius: 12px; padding: 20px; border: 1px solid #93c5fd;">
              <div style="font-size: 11pt; font-weight: 600; color: #1e40af; margin-bottom: 15px; display: flex; align-items: center; gap: 8px;">
                📊 Como Interpretar as 5 Dimensões de Análise
              </div>
              <p style="font-size: 9pt; color: #475569; margin-bottom: 15px; line-height: 1.6;">
                O gráfico de radar e as barras de progresso mostram seu nível de compatibilidade em cada dimensão. Quanto maior o valor (mais próximo de 100), melhor o país atende àquele critério para seu perfil.
              </p>
              <div style="display: grid; grid-template-columns: repeat(1, 1fr); gap: 10px; font-size: 9pt;">
                <div style="background: white; padding: 12px 15px; border-radius: 8px; display: flex; align-items: flex-start; gap: 12px;">
                  <div style="min-width: 100px;">
                    <div style="display: flex; align-items: center; gap: 6px;">
                      <div style="width: 12px; height: 12px; background: #3b82f6; border-radius: 3px;"></div>
                      <strong style="color: #1e40af;">Viabilidade</strong>
                    </div>
                    <div style="color: #64748b; font-size: 8pt;">Peso: 35%</div>
                  </div>
                  <p style="color: #475569; line-height: 1.5; flex: 1;"><strong>O que mede:</strong> Suas chances reais de obter o visto. <strong>Baseado em:</strong> área de atuação, anos de experiência, formação acadêmica, nível de inglês, prêmios, publicações e se possui cidadania europeia. <strong>Por que importa:</strong> É o critério mais importante pois determina se você consegue ou não imigrar.</p>
                </div>
                <div style="background: white; padding: 12px 15px; border-radius: 8px; display: flex; align-items: flex-start; gap: 12px;">
                  <div style="min-width: 100px;">
                    <div style="display: flex; align-items: center; gap: 6px;">
                      <div style="width: 12px; height: 12px; background: #8b5cf6; border-radius: 3px;"></div>
                      <strong style="color: #6d28d9;">Alinhamento</strong>
                    </div>
                    <div style="color: #64748b; font-size: 8pt;">Peso: 25%</div>
                  </div>
                  <p style="color: #475569; line-height: 1.5; flex: 1;"><strong>O que mede:</strong> O quanto o país combina com suas preferências. <strong>Baseado em:</strong> países de interesse declarados, preferência de clima, idiomas que fala, se tem filhos e tamanho da comunidade brasileira. <strong>Por que importa:</strong> Garante satisfação e adaptação a longo prazo.</p>
                </div>
                <div style="background: white; padding: 12px 15px; border-radius: 8px; display: flex; align-items: flex-start; gap: 12px;">
                  <div style="min-width: 100px;">
                    <div style="display: flex; align-items: center; gap: 6px;">
                      <div style="width: 12px; height: 12px; background: #22c55e; border-radius: 3px;"></div>
                      <strong style="color: #166534;">Timeline</strong>
                    </div>
                    <div style="color: #64748b; font-size: 8pt;">Peso: 15%</div>
                  </div>
                  <p style="color: #475569; line-height: 1.5; flex: 1;"><strong>O que mede:</strong> Velocidade do processo migratório. <strong>Baseado em:</strong> tempo médio de processamento do país versus seu prazo desejado. <strong>Por que importa:</strong> Se você tem urgência, países com processos rápidos (Holanda, Emirados, Mercosul) ganham vantagem.</p>
                </div>
                <div style="background: white; padding: 12px 15px; border-radius: 8px; display: flex; align-items: flex-start; gap: 12px;">
                  <div style="min-width: 100px;">
                    <div style="display: flex; align-items: center; gap: 6px;">
                      <div style="width: 12px; height: 12px; background: #f59e0b; border-radius: 3px;"></div>
                      <strong style="color: #a16207;">Custo-Benefício</strong>
                    </div>
                    <div style="color: #64748b; font-size: 8pt;">Peso: 15%</div>
                  </div>
                  <p style="color: #475569; line-height: 1.5; flex: 1;"><strong>O que mede:</strong> Relação entre investimento necessário e seu orçamento. <strong>Baseado em:</strong> custo do processo, custo de vida do país e sua capacidade financeira declarada. <strong>Por que importa:</strong> Evita comprometer suas finanças ou escolher opções fora do alcance.</p>
                </div>
                <div style="background: white; padding: 12px 15px; border-radius: 8px; display: flex; align-items: flex-start; gap: 12px;">
                  <div style="min-width: 100px;">
                    <div style="display: flex; align-items: center; gap: 6px;">
                      <div style="width: 12px; height: 12px; background: #ec4899; border-radius: 3px;"></div>
                      <strong style="color: #be185d;">Potencial LP</strong>
                    </div>
                    <div style="color: #64748b; font-size: 8pt;">Peso: 10%</div>
                  </div>
                  <p style="color: #475569; line-height: 1.5; flex: 1;"><strong>O que mede:</strong> Perspectiva de longo prazo no país. <strong>Baseado em:</strong> tempo para cidadania, possibilidade de naturalização e benefícios do passaporte (ex: acesso à UE). <strong>Por que importa:</strong> Considera seu futuro além do visto inicial, incluindo estabilidade permanente.</p>
                </div>
              </div>
            </div>
          </div>
